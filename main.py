...
from forms import CreatePostForm, RegistorForm, LoginForm, CommentForm
...
def register():
    ...
    if form.validate_on_submit():
        ...
        if User.query.filter_by(email=email).first():
            flash("Your email already exists in database! Log in instead!")
...
def show_post(post_id):
    ...
    return render_template("post.html", post=requested_post, current_user=current_user, logged_in=current_user.is_authenticated, form=comment_form)
